...
def compact_exclusion_table(file_path: str, terms: list[str], group: str) -> pl.DataFrame:
...
# Execute
data_path = str(REPO_ROOT / "playground" / "semantic_papers_all.parquet")
